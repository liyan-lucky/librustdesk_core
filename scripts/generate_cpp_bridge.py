...
_project_root = os.path.resolve(os.path.join(_script_dir, '..'))
BRIDGE_API_RS = os.path.join(_project_root, 'rustdesk-master', 'src', 'harmony_bridge', 'core.rs')
ABI_HEADER = os.path.join(_project_root, 'cpp', 'rustdesk_bridge_abi.h')
LOADER_CPP = os.path.join(_project_root, 'cpp', 'rustdesk_bridge_loader.cpp')
