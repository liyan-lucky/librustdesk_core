...
2026-06-21 23:51 实测：`_tmp_rustdesk_1_4_7_src` 不存在；前两次可计量 RustDesk 白名单清理释放 `1,348,092,177` bytes，最终审计后再次清理重建产物；共享根 3 个 APK 的数量、大小、SHA256 不变。Core 最新备份为 `99_Temp\rustdesk_core_backups\rustdesk_core_20260621_235131.zip`（`3,592,925` bytes，SHA256 `E2CFF8937F62325BF7A8AD0081935D3347F9B62192E5490F52FAEB552D09875B`），目录只保留最新 2 份 zip 及 `.sha256`。
