...
> 2026-06-22 线上归档：Core `a7f7795` / run `27920089950` / `core-34`；arm64 `133495306 / 90A28361...`，x86_64 `131336988 / E587465E...`。最终 App run `27920708116` 的 HAP SHA256 `3D2711AF...` 已下载并在 arm64 真机与 x86_64 虚拟机复验。完整哈希与纠错记录见 `CORE.md`、`CONNECTION_DEBUG_LOG.md`。
