...
fn main() {
    ...
    if target_os == "ios" {
        ...
        // OHOS uses a linux-like Rust target triple, but it has no desktop
        // capture stack. Keep scrap's codec/common types available without
        // enabling X11 or Windows DXGI modules during cross compilation.
    } else if target_os == "windows" {
    ...
    } else if target_os == "linux" || target_os == "freebsd" || target_os == "openbsd" {
